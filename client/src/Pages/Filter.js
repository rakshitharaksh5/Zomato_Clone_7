...
class Filter extends React.Component{
   ...
   handleNavigate = (ss) => {
    ...
    render(){
        ...
        const{ location, restaurants, mealt } = this.state;
               ...
               {/* <!--Result-01-->*/}
                   {    
                        ...
                        return(
                            ...
                            <div class="d-flex">
                                <div class="lt-box">
                                    <img src={res.thumb} alt="not found" class="img-fluid img-qs" />
                                </div>
                                <div class="rt-box">
                ...
                <div class="results">
                    <div class="d-flex">
                        <div class="lt-box">
                            <img src="./Images/1.png" alt="not found" class="img-fluid img-qs" />
                        </div>
                        <div class="rt-box">
